...
# 예측 실행
def predict_stock_price(stock_code, start_date, end_date, look_back=1, epochs=100):
    # 주식 데이터 가져오기
...
2. NVDIA
3. 삼성전자''')
predict_stock_price(stock_list[stock], '2023-01-01', '2023-11-06', look_back=5, epochs=100)
